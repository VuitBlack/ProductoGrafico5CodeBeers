...
import java.text.DateFormat; // PROBABLY WE DON'T NEED THIS. JUST USE LocalDateTime
import java.text.SimpleDateFormat; // PROBABLY WE DON'T NEED THIS. JUST USE LocalDateTime
import java.time.LocalDate; // PROBABLY WE DON'T NEED THIS. JUST USE LocalDateTime
...
public class Pedido {
    ...
    public float precioEnvio() {
        return articulo.getGastosEnvio() * getCantidad() * (1f - cliente.descuentoEnv());
    }

    public float getTotal() {
        return precioEnvio() + (getCantidad() * articulo.getPvp());
    }
